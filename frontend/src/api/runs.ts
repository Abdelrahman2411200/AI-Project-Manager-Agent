...
export const runKeys = {
  ...
  active: (projectId: string) => [...runKeys.all, "active", projectId] as const,
...
export function getActivePlanningRun(projectId: string): Promise<AgentRunView | null> {
  return requestJson<AgentRunView | null>(`/projects/${projectId}/planning-runs/active`);
}
