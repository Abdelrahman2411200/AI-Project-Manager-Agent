...
| NFR-007 API performance | live Uvicorn/PostgreSQL gate performs three 50-concurrency rounds and calculates p95 over 150 authenticated reads and 150 writes; shell `pipefail` preserves a failed benchmark exit |
